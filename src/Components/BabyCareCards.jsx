                ...
                <div className="row pb-5">
                    ...
                    <div className="card-deck">
                        ...
                        <div className="card border-0 shadow-sm p-3 mb-5 ">
                            <img className="card-img-top" src="/images/babyCare1.png" alt=".."></img>
                            ...
                            <img src="/images/greenArrow.png"  alt=".."></img>
                            </div>
                        </div>
                        
                        <div className="card border-0 shadow-sm p-3 mb-5 ">
                            <img className="card-img-top" src="/images/babyCare2.png" alt=".."></img>
                            <div className="card-body">
                        ...
                        <div className="card border-0 shadow-sm p-3 mb-5">
                            <img className="card-img-top" src="/images/babyCare3.png" alt=".."></img>
                            <div className="card-body">
