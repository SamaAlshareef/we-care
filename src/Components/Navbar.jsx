        ...
        return (  
            ...
            <div className="container-fluid bg-img"  ref ={this.ref}>
                ...
                <div className="row h-100 pt-6 mt-5 jusitfy-content-left">
                    <div className="col pt-3 mt-5 pl-6 "> 
                            <div className="row">
                            ...
                            <p className="pb-1">It is a long established fact that a reader will be distracted by the readable</p>
                            <p className="pb-1"> content of a page when looking at its layout. The point of using Lorem Ipsum</p> 
                            <p className="pb-2"> is that it has a more-or-less normal distribution of letters,</p> 
